...
#     # Modify the system prompt to explicitly request only the roadmap
#     roadmap_prompt = """
...
#     Generate a detailed immigration roadmap that outlines the specific steps, timelines, and requirements for the candidate's path to Canadian immigration. 
#     Focus ONLY on the actionable steps and timeline. 
#     DO NOT include or repeat the questionnaire details, CRS score breakdown, job roles, or NOC codes in the output.
    
#     The roadmap should be clear, concise, and chronologically organized.
#     """
